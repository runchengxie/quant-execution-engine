...
| 我想理解研究结果进入执行前如何隔离验证和审计 | `research-handoff-governance.md` |
...
1. 准备接入研究输出：`targets.md` -> `research-handoff-governance.md` -> `cli.md` 的 `rebalance` 部分 -> `current-capabilities.md`
